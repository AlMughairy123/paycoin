...
MYWAL_Content_3             : 'Ha használni akarod ezt a tárcát a PayCoinWallet CX-szel a jövőben, manuálisan újra hozzá kell majd adnod a privát kulcs/JSON-nal és jelszóval. ',
...
ERROR_28                    : '**Szükséged lesz a Keystore Fájlra és a jelszóra vagy a Privát Kulcsra**, ahhoz, hogy hozzáférj ehhez a tárcához a jövőben. Kérlek mentsd el és készíts külső biztonsági mentést is! Nincs lehetőség egy tárca visszaszerzésére, ha nem mented el. Olvasd el a [Segítség lapot](https://www.PayCoinWallet.com/#help) további instrukciókért. ',
...
TranslatorName_1            : '[belpheg](https://www.PayCoinWallet.com/?gaslimit=21000&to=0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f&value=1.0#send-transaction) · ',
TranslatorAddr_1            : '0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f ',
/* Translator 1             : email: zoltan.tapi@donamin.com */
TranslatorName_2            : '[bluqesh](https://www.PayCoinWallet.com/?gaslimit=21000&to=0x4270A331d14CcdB6FB941f3f5De9Cf01607Bff9F&value=1.0#send-transaction) ',
...
HELP_0_Desc_1               : 'A PayCoinWallet-tel új tárcákat lehet létrehozni, hogy saját magadnál tudd tárolni az Ethert, és nem egy exchange-nél. Ez a folyamat teljesen a te gépeden történik, nem a mi szerverünkön, így amikor létrehozol egy új tárcát **a te felelősséged biztonságosan tárolni azt**. ',
...
HELP_2b_Title               : '2b) Hogyan tudom biztonságosan/offline/hidegen használni a PayCoinWallet-et? ',
...
HELP_3_Desc_3               : 'Menj a PayCoinWallet.com-on a "Tárca adatainak megtekintése" oldalra. ',
...
HELP_5_Title                : '5) Hogyan lehet a PayCoinWallet-et offline/lokálisan használni? ',
HELP_5_Desc_1               : 'Futtahatod a PayCoinWallet.com-ot a saját számítógépeden is, a GitHub szerverei nélkül. Így lehetőséged van teljesen offline generálni tárcákat, vagy Ethert küldeni az "Offline tranzakció" oldalról. ',
HELP_5_Desc_7               : 'A PayCoinWallet.com most teljesen a te számítógépedről fut. ',
HELP_5_Desc_8               : 'Ha esetleg nem csináltál volna még ilyet: a teljes mappára szükséged van az oldal futtatásához, nem elég csak az "index.html" fájl. A mappában ne piszkálj / mozgass el semmit. Ha biztonsági másolatot szeretnél a PayCoinWallet repo-ról későbbre, akkor az eredeti zip fájl tárolását javasoljuk, így biztos lehetsz benne hogy a tartalma érintetlen marad. ',
HELP_5_Desc_9               : 'Mivel folyamatosan frissítjük a PayCoinWallet.com-ot, ezért javasoljuk, hogy időközönként frissítsd a lementett repo-t is. ',
