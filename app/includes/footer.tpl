<section class="pre-footer">
  <div class="container">
    <p>
      PayCoinwallet.com does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="/"><img src="images/logo-PayCoinwallet.svg" height="45px" width="auto" alt="Ether Wallet" class="footer--logo"/></a>

      <p>
        <span translate="FOOTER_1">
          Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( PayCoinwallet.com ) before unlocking your wallet.
        </span>
      </p>

      <p>
        <a aria-label="knowledge base" href="https://PayCoinwallet.github.io/knowledge-base/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Knowledge Base
        </a>
      </p>
    ...
    <section class="footer--cent">
        ...
        <div class="footer__pill-wrap">
          ...
          <a class="footer__pill" href="https://trezor.io/?a=PayCoinwallet.com" target="_blank" rel="noopener">TREZOR</a>
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="website via my ether wallet dot com" href="https://www.PayCoinwallet.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          PayCoinwallet.com
        </a>
      </p>
      <p>
        <a aria-label="PayCoinwallet team" href="https://team.PayCoinwallet.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          PayCoinwallet Team
        </a>
      </p>
      <p>
        <a aria-label="support email" href="mailto:support@PayCoinwallet.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Email support: support@PayCoinwallet.com
        </a>
      </p>
      <p>
        <a href="https://www.PayCoinwallet.com/helpers.html" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Unit Converters &amp; ENS Debugging
        </a>
      </p>

      <p>
        <a href="https://www.PayCoinwallet.com/signmsg.html" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Sign Message
        </a>
      </p>
      ...
      <p>
        <a aria-label="my ether wallet chrome extension" href="https://chrome.google.com/webstore/detail/PayCoinwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm?hl=en" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          PayCoinwallet Chrome Extension
        </a>
      </p>
      ...
      <p>
        <a href="https://instagram.com/PayCoinwallet" aria-label="instagram" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="reddit" href="https://www.reddit.com/r/PayCoinwallet/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="twitter" title="twitter" href="https://twitter.com/PayCoinwallet" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="facebook" title="facebook" href="https://www.facebook.com/PayCoinwallet/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="medium" title="medium" href="https://medium.com/@PayCoinwallet" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="linkedin" title="linkedin" href="https://www.linkedin.com/company/PayCoinwallet" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/PayCoinwallet" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="support email" title="support email" href="mailto:support@PayCoinwallet.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
